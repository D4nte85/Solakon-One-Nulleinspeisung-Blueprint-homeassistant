...
    B2_D --> C0
    ...
    %% FALL E: Modus/Zyklus bereits korrekt --> C0
    B0 -- DEFAULT --> C0
...
    C5_B1 -- JA --> C6_B1[<span style='font-size:120%'>Berechne Power Limit:<br>min(P-Regler, PV-Power - PV-Reserve)</span>]
    C6_B1 --> A_END
    C5_B1 -- NEIN --> A_END
...
    C5_B2 -- JA --> C6_B2[<span style='font-size:120%'>Berechne Power Limit:<br>max(min(P-Regler, Hard Limit), 0 W)</span>]
    C6_B2 --> A_END
    C5_B2 -- NEIN --> A_END
