...
graph TD
    ...
    C5_B1 -- JA --> C6_B1[Power Limit Zone 2:<br>min(P-Regler, PV-Power - PV-Reserve)]
    C6_B1 --> A_END
    C5_B1 -- NEIN --> A_END

    %% B2: Zone 1: Aggressiv
    C3 -- B2: Zone 1 Aggressiv ODER Zyklus ON --> C4_B2[/Definiere Offset 0 W<br>Toleranzfenster/]
    C4_B2 --> C5_B2{Netzleistung<br>ausserhalb Toleranz?}
    C5_B2 -- JA --> C6_B2[Power Limit Zone 1:<br>max(min(P-Regler, Hard Limit), 0 W)]
    C6_B2 --> A_END
    C5_B2 -- NEIN --> A_END
