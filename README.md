...
12. **AC Laden:** Gilt in Zone 1 und Zone 2. Zone 3 (SOC-Schutz) hat immer Vorrang. Eintritt wird erkannt über (Grid + Ausgangsleistung) < −Toleranz, Verbleib über Grid < Hysterese.
